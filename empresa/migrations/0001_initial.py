# Generated by Django 3.0.8 on 2021-10-31 01:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('funcionarios', models.ManyToManyField(blank=True, related_name='funcionarios', to='empresa.Funcionarios')),
                ('supervisor', models.ManyToManyField(blank=True, related_name='supervisor', to='empresa.Funcionarios')),
            ],
            options={
                'ordering': ['id'],
            },
